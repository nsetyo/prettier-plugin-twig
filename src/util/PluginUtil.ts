...
export const getPluginPathsFromOptions = (options) => {
...
export const tryLoadPlugin = (pluginPath) => {
	try {
...
export const loadPlugins = (pluginPaths) => {
	const result: any[] = []
...
export const getAdditionalMelodyExtensions = (pluginPaths) => {
	let result = []
